      ...
      <div class="modal-content etn-org-event-social-content">
         ...
         <div class="modal-body etn-social-icon-search-input">
            <div class="input-group etn-modal-search-box">
               ...
               <input placeholder="search icon" type="text" class="attr-form-control etn-search-event-mng-social" />
            </div>
            <?php $etn_etn_icons = Utilities::etn_event_manager_fontawesome_icons(); ?>
            <div class="etn-social-icon-list">
               <?php foreach ($etn_etn_icons as $icon_key => $value) :  ?>
