...
class Etn_Schedule extends Widget_Base
{
    ...
    {
        return __('Eventin schedule', 'eventin');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'desc_style',
            [
                'label' => __('Description style', 'eventin'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        //control for nav typography
        ...
        $this->start_controls_section(
            'schedule_time_style',
            [
                'label' => __('Schedule Time style', 'eventin'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        //control for nav typography
    ...
    protected function render()
    {
        ...
        include_once ETN_DIR . "/widgets/schedule/style/{$style}.php";
    }


    protected function get_schedules()
    {
        return    Utilities::get_schedules();
    }
}
