...
class Etn_Speakers extends Widget_Base
{
	...
	{
		return __('Eventin speaker', 'eventin');
	}
	...
	protected function _register_controls()
	{
		...
		$this->start_controls_section(
			'title_section',
			[
				'label' => __('Title Section', 'eventin'),
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Designation Section', 'eventin'),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'social_section',
			[
				'label' => __('Social Section', 'eventin'),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'advance_section',
			[
				'label' => __('Advance Section', 'eventin'),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		// tab controls start
...
?>
	<?php
		include_once ETN_DIR . "/widgets/speakers/style/{$style}.php";
	}

	protected function get_speakers()
	{
		return	Utilities::get_speakers();
	}

	protected function get_speakers_category()
	{
		return	Utilities::get_speakers_category();
	}
}
