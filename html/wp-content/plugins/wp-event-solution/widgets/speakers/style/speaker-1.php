...
use \WpEvently\Utils\Helper as Helper;
        ...
        <div class="etn-speaker-item">
            <div class="etn-speaker-thumb">
                <?php if (!is_null($data["photo"])) : ?>
                    <img src="<?php echo esc_url($data['photo']); ?>" class="img-fluid" />
                <?php endif; ?>
            ...
            <div class="etn-speaker-content">
                <h3 class="etn-title etn-speaker-title"><a href="<?php echo esc_url(get_the_permalink()); ?>"> <?php echo esc_html(get_the_title($speaker_id)); ?></a> </h3>
                <p>
                    <?php echo esc_html($data['etn_speaker_designation']); ?>
                </p>
            </div>
        </div>
    </div>
