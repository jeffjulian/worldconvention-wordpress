        ...
        $this->start_controls_section(
         ...
         $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'default' => [
                    [ 'name' => esc_html__(' Team #1', 'exhibz') ],
         
                ],
                'fields' => [
                    [
                        'name' => 'exhibz_team_title',
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="ts-speaker">
                                <div class="speaker-img">
                                    <img src="<?php echo is_array($team["exhibz_team_image"])?$team["exhibz_team_image"]["url"]:''; ?>" alt="">
                                    <a  href="<?php echo esc_url($team["exhibz_team_url"]['url']); ?>" class="view-speaker" target="_blank">
                                        <i class="icon icon-plus"></i>
                                    </a>
                                </div>
                                <div class="ts-speaker-info">
                                    <h3 class="ts-title"> 
                                        <a href="<?php echo esc_url($team["exhibz_team_url"]['url']); ?>" target="_blank"> 
