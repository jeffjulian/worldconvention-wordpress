...
?>
                ...
                <div class="ts-pricing-box">
                    <div class="ts-pricing-header">
                        ...
                        <h3 class="ts-pricing-price">
                            <span class="currency"><?php echo esc_html($currency); ?></span><?php echo esc_html($price); ?>
                        </h3>
                    </div>
                    ...
                    <div class="promotional-code">
                        ...
                        <a target="<?php echo esc_attr($price_button_url["is_external"] == "on" ? "_blank" : '_self'); ?>" rel="<?php echo esc_attr($price_button_url["nofollow"] == "on" ? "" : 'nofollow'); ?>" href="<?php echo esc_url($price_button_url["url"]); ?>" class="btn pricing-btn"><?php echo esc_html($price_button_text); ?></a>
        ...
        <?php elseif ($style == "icon-price") : ?>
            <div class="ts-pricing-item <?php echo esc_attr($price_featured == "yes" ? "active" : ''); ?> <?php echo esc_attr($price_disable == "yes" ? 'disebled' : ''); ?>">
                ...
                <a target="<?php echo esc_attr($price_button_url["is_external"] == "on" ? "_blank" : '_self'); ?>" rel="<?php echo esc_attr($price_button_url["nofollow"] == "on" ? "" : 'nofollow'); ?>" href="<?php echo esc_url($price_button_url["url"]); ?>" class="btn btn-round"><?php echo esc_html($price_button_text); ?></a>
            </div>
        <?php endif; ?>
