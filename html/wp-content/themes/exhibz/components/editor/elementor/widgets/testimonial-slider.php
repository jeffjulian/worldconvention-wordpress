...
class Exhibz_Testimonial_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('quote_slider_count',
         ...
         $this->add_control('quote_carousel',
            [
                ...
                'default'       => [
                     [ 
                       'name'   => esc_html__('Thomas Edison', 'exhibz')
                     ],
    ...
    protected function render( ) {
        ...
        <div data-count="<?php echo esc_attr($quote_slider_count); ?>" data-nav="<?php echo esc_attr($show_navigation=="yes"?true:false); ?>" data-autoplay="<?php echo esc_attr($autoplay_onoff=="yes"?true:false); ?>" class="testimonial-carousel owl-carousel" >
