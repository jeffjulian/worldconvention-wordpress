    ...
    'header_settings' => [
        ...
        'options'	 => [
            ...
            'header_layout_style' => [
                ...
                'choices'       => [
                   ...
                   'standard'    => [
                    ...
                    'fullwidthsolid'    => [
                        'small'     => EXHIBZ_IMG . '/admin/header-style/style8.png',
                        'large'     => EXHIBZ_IMG . '/admin/header-style/style8.png',
                    ],
                    'woo'    => [
                        'small'     => EXHIBZ_IMG . '/admin/header-style/style9.png',
                        'large'     => EXHIBZ_IMG . '/admin/header-style/style9.png',
                    ],
                ],
                'value'         => 'standard',
             ], //Header style
            ...
            'header_nav_shopping_cart_section' => [
                'type'			 => 'switch',
                'label'		 => esc_html__( 'Shopping cart show', 'exhibz' ),
                'desc'			 => esc_html__( 'Only for header woo ', 'exhibz' ),
                'value'       => 'yes',
                'left-choice'	 => [
                   'value'   	     => 'yes',
                   'label'	        => esc_html__( 'Yes', 'exhibz' ),
