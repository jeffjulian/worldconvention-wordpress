			...
			<div class="section-edit">
				<div class="container relative">
					...
					<span class="section-abc"><?php echo esc_html(get_the_title()); ?> <?php echo esc_html__('Or', 'exhibz') ?>
						<a href="<?php echo esc_url(home_url('/')); ?>/wp-admin/post.php?post=<?php the_ID(); ?>&action=elementor" target="_blank"><?php echo esc_html__('Edit with elementor', 'exhibz') ?></a></span>
